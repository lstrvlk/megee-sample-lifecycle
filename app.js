...
const filterPresets={
  samples:[['状态',['可用','预留','待补样']],['类别',['常规库存样','新品发布样','客户定制样','PPS 留样','颜色限度样']],['样品类型',['标准样品','客户定制样','颜色限度样','PPS 标准样']],['客户',['通用','海澜美妆','沐光个护','蓝岸日化','诺安生物','青屿实验室']],['库区',['A-','B-','C-','PPS']],['责任人',['赵敏','林知夏','周明','陈柯','王若兰']]],
  requests:[['状态',['待审批','待备货','待寄出','已签收','待客户确认']],['费用',['不收费','待报价','已减免']],['客户',['海澜美妆','沐光个护','蓝岸日化','诺安生物','青屿实验室']],['用途',['新客户开发','老客户补样','新品推广','项目开发','订单确认','展会样品']],['负责人',['李雯','林知夏','周明']]],
  tasks:[['优先级',['高','普通']],['状态',['即将到期','待检验','待审批','待客户确认','待寄出']],['任务',['PPS 续签','样品检验','索样审批','费用确认','寄样出库']],['客户',['沐光个护','海澜美妆','蓝岸日化']]],
  development:[['状态',['待评估','打样中','待检验','待客户反馈','可转标准样']],['需求类型',['市场驱动','技术驱动','客户驱动','质量驱动','新模首样']],['产品系列',['乳液泵系列','泡沫泵系列','喷雾泵系列','真空泵系列','套装系列']],['品管',['待检验','内部通过','需复测']],['费用',['需报价','特殊工艺收费','不收费']],['责任人',['周明','陈柯','林知夏']]],
  inventory:[['动作',['入库','出库','预留','调拨','盘点调整']],['库区',['A-','B-','C-','PPS']],['操作人',['赵敏','林知夏','周明']]],
  shipments:[['状态',['待业务确认','后台已放行','待快递取件','已取件','运输中','已签收']],['快递',['顺丰速运','京东物流','跨越速运']],['客户',['海澜美妆','沐光个护','蓝岸日化','诺安生物']],['业务员',['林知夏','李雯','周明']],['样品组',['赵敏','林知夏']]],
  charges:[['状态',['待客户确认','已减免','已收费']],['收费类型',['特殊电镀','库存样管理费','新结构打样']],['客户',['海澜美妆','沐光个护','蓝岸日化','诺安生物']]],
  pps:[['状态',['生效中','即将到期','待客户批准','已过期']],['客户',['海澜美妆','沐光个护','蓝岸日化','青屿实验室']],['版本',['V1','V2','V3','V4']]],
  settings:[['角色',['业务部','品管部','打样组','样品组','管理员','超级管理员']],['范围',['全部数据','部门数据','本人数据','字段级脱敏']]],
  dashboard:[['状态',['待审批','待备货','待寄出','即将到期','待客户批准','已过期','出库','入库']],['费用',['不收费','已减免','待报价']],['快递',['顺丰速运','京东物流','跨越速运']]]
};
